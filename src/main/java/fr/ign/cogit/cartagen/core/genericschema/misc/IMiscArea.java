 ...
 * surfaciques Author: J. Renard Date: 16/09/2009
 */

public interface IMiscArea extends IGeneObjSurf {
  public static final String FEAT_TYPE_NAME = "MiscArea"; //$NON-NLS-1$
}
