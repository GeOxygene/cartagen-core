...
public class CoalescenceConflict extends NetworkConflict {

  public CoalescenceConflict(Set<INetworkSection> sections) {
    super(sections);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    CoalescenceConflict other = (CoalescenceConflict) obj;
    if (getSections() == null) {
